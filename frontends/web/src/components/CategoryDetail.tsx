        ...
        >
            <div className="flex items-center justify-between">
                <div>
                    <div className="flex items-center gap-3">
                        <span className="text-brand-400 text-sm font-medium uppercase tracking-wider">Category Detail</span>
                        <span className="bg-brand-500/20 text-brand-300 px-2 py-0.5 rounded text-xs border border-brand-500/30">Drilldown Mode</span>
                    </div>
                    <h2 className="text-3xl font-bold text-white mt-1">{category}</h2>
                </div>
                <button
                    onClick={onClose}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl flex flex-col justify-center">
                    ...
                    <p className="text-slate-500 mt-2 text-sm">{count} transactions in this period</p>
                </div>
                <MerchantsChart transactions={transactions} />
            </div>

            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
                <h3 className="text-slate-100 text-lg font-semibold mb-4">Transactions in {category}</h3>
